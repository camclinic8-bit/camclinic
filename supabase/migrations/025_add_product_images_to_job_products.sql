-- Migration: 025_add_product_images_to_job_products.sql
-- Purpose: Add product_images TEXT[] column to job_products and update RPC functions to handle this field

-- Add product_images column to job_products table
ALTER TABLE job_products
ADD COLUMN IF NOT EXISTS product_images TEXT[] DEFAULT ARRAY[]::TEXT[];

COMMENT ON COLUMN job_products.product_images IS 'Base64 encoded or URL paths of compressed product photos (maximum 8)';
