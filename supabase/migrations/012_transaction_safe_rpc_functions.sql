...
-- Migration: 012_transaction_safe_rpc_functions.sql
-- Purpose: Wrap multi-table operations in PostgreSQL transactions to prevent data corruption

-- ============================================================================
-- FUNCTION: create_job_with_products
-- Creates a job with all related data in a single transaction
-- ============================================================================
...
-- Updates a job and syncs products in a single transaction
-- ============================================================================
...
-- ============================================================================
-- FUNCTION: update_job_status_with_history
-- Updates job status and logs history in a single transaction
-- ============================================================================
...
BEGIN
  ...
  -- Update status (and set service_date if completed)
  UPDATE jobs SET
    status = p_status,
...
-- Grant execute to authenticated users
GRANT EXECUTE ON FUNCTION update_job_status_with_history TO authenticated;
